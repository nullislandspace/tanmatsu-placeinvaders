...
install: build
install:
	cd badgelink/tools; ./badgelink.sh appfs upload placeinvaders "Place Invaders" 0 ../../$(BUILD)/placeinvaders.bin

.PHONY: run
run:
	cd badgelink/tools; ./badgelink.sh start placeinvaders
